...
import com.xiaolv.meta.enums.ModelTypeEnum;
...
//            String type = fileInfo.getType();
    ...
    private static void validAndFillMetaRoot(com.xiaolv.meta.Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "吕小匠");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.xiaolv");
